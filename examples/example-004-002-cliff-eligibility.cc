...
int main(int argc, char* argv[]) {
  ...
  ////////////// Actor/Critic
  // 2a) Instantiate the Critic, we here use TD-V, i.e. without Eligibility Traces, but it is just because we do not have yet TD(lambda) in RlLib
  ...
  auto actor_critic = rl::gsl::ActorVCritic::eligibility_traces<S, A>(critic,
								     paramGAMMA,
								     theta_p,
								     paramALPHA_P,
								     paramLAMBDA_P,
